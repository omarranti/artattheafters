            ...
            >
              ...
              <div className="flex items-center justify-center h-36 mb-4">
                <motion.div
                  ...
                  whileHover={{
                    borderColor: "rgba(91,255,160,0.7)",
                    backgroundColor: "rgba(91,255,160,0.1)",
                  }}
              ...
              <div className="mt-auto w-full">
                <a
                  ...
                  className="rounded-full px-5 py-3.5 min-h-[48px] text-sm font-body uppercase tracking-wider text-brand-pink bg-brand-pink/15 border border-brand-pink/30 hover:bg-brand-pink/25 hover:border-brand-pink/40 transition-colors inline-flex items-center justify-center w-full"
                >
                  Start Your Piece
                </a>
              </div>
