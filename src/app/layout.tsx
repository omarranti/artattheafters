...
export const metadata: Metadata = {
  ...
  description: 'One of a kind custom made artwork, delivered to you. 75+ hand-painted pieces sold across 5 countries and 17 cities. Custom paintings from $45 by LA artist Stevie Alger.',
